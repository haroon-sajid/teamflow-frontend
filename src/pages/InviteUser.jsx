...
// import { invitationAPI } from "../api/invitationAPI";
// import { removeMemberFromOrganization } from "../api/invitationAPI"; // Import the new API function
// import { AuthContext } from "../context/AuthContext";
...
//   const [resendingInvitation, setResendingInvitation] = useState(null);
//   const [revokingInvitation, setRevokingInvitation] = useState(null);
//   const [removingMember, setRemovingMember] = useState(null); // New state for removal loading
...
//   // ✅ NEW: Handle Remove Member
//   const handleRemoveMember = async (userId, email) => {
//     setConfirmationConfig({
//       title: "Remove Member",
//       message: `Are you sure you want to remove ${email} from your organization? They will lose access immediately.`,
//       onConfirm: async () => {
//         try {
...
//                             <>
//                               <button
//                                 className="invitation-action-btn invitation-send-new-btn"
//                                 onClick={() => handleResendInvitation(invitation.email)}
//                               >
//                                 Resend
//                               </button>
//                               <button
//                                 className="invitation-action-btn invitation-manage-btn"
//                                 onClick={() => handleRemoveMember(invitation.user_id, invitation.email)}
//                                 disabled={removingMember === invitation.user_id}
//                               >
//                                 {removingMember === invitation.user_id ? 'Removing...' : 'Remove'}
//                               </button>
//                             </>
//                           )}
//                         </div>
